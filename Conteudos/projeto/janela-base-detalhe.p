...
DEFINE PARAMETER BUFFER <tabela> FOR <tabela>.
...
DEFINE FRAME FrameCRUDA
    ...
    AT ROW  1.5 COL 50 COLON-ALIGNED
    AT ROW  2.5 COL 50 COLON-ALIGNED
    
    AT ROW  3.5 COL 50 COLON-ALIGNED
    AT ROW  4.5 COL 50 COLON-ALIGNED
    AT ROW  5.5 COL 50 COLON-ALIGNED
    AT ROW  6.5 COL 50 COLON-ALIGNED
    AT ROW  7.5 COL 50 COLON-ALIGNED
    AT ROW  8.5 COL 50 COLON-ALIGNED
    
    AT ROW  9.5 COL 50 COLON-ALIGNED
    AT ROW 10.5 COL 50 COLON-ALIGNED
    AT ROW 11.5 COL 50 COLON-ALIGNED
    AT ROW 12.5 COL 50 COLON-ALIGNED
    
    AT ROW 13.5 COL 50 COLON-ALIGNED
    AT ROW 14.5 COL 50 COLON-ALIGNED
    AT ROW 15.5 COL 50 COLON-ALIGNED
    AT ROW 16.5 COL 50 COLON-ALIGNED
    AT ROW 17.5 COL 50 COLON-ALIGNED
    
    AT ROW 18.5 COL 50 COLON-ALIGNED FORMAT 'x(50)'
...
ASSIGN CURRENT-WINDOW                = JanelaCRUDA 
       THIS-PROCEDURE:CURRENT-WINDOW = JanelaCRUDA.
